...
setup(
    ...
    packages=find_packages(),  # Automatically find all packages under src
    ...
    # entry_points={
    #     "console_scripts": [
    #         "mlops=mlops.cli.cli_entrypoint:main",  # Enables CLI functionality
    #     ],
    # },
    package_data={
        "infra": ["infra/*", "infra/minio/*", "infra/mlflow/*", "infra/postgres/*"],  # Explicitly include infra files
    },
    classifiers=[
